...
from VQFR.vqfr.archs.inception import InceptionV3


def load_patched_inception_v3(device, resize_input=True, normalize_input=False):
...
@torch.no_grad()
def extract_inception_features(data_generator, inception, device, len_generator=None):
