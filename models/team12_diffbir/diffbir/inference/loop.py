...
class InferenceLoop:
    ...
    def load_cldm(self) -> None:
        self.cldm: ControlLDM = instantiate_from_config(
            OmegaConf.load("models/team12_diffbir/configs/inference/cldm.yaml")
        )
        ...
        if self.args.version in ["v1", "v2"]:
            config = "models/team12_diffbir/configs/inference/diffusion.yaml"
        else:
            config = "models/team12_diffbir/configs/inference/diffusion_v2.1.yaml"
