...
dlib_model_url = {
    'face_detector': 'https://kkgithub.com/sczhou/CodeFormer/releases/download/v0.1.0/mmod_human_face_detector-4cb19393.dat',
    'shape_predictor_5': 'https://kkgithub.com/sczhou/CodeFormer/releases/download/v0.1.0/shape_predictor_5_face_landmarks-c4b1e980.dat'
}
...
class FaceRestoreHelper(object):
    ...
    def __init__(self,
        ...
        if self.det_model == 'dlib':
            ...
            self.face_detector = init_detection_model(det_model, model_dir, half=False, device=self.device)

        # init face parsing model
        self.use_parse = use_parse
        self.face_parse = init_parsing_model(model_name='parsenet', model_dir=model_dir, device=self.device)
