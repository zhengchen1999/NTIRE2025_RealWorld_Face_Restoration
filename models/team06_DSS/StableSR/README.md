...
[Paper](https://arxiv.org/abs/2305.07015) | [Project Page](https://iceclear.github.io/projects/stablesr/) | [Video](https://www.youtube.com/watch?v=5MZy9Uhpkw4) | [WebUI](https://kkgithub.com/pkuliyi2015/sd-webui-stablesr) | [ModelScope](https://modelscope.cn/models/xhlin129/cv_stablesr_image-super-resolution/summary) | [ComfyUI](https://kkgithub.com/gameltb/comfyui-stablesr)
...
### Update
- **2024.06.28**: Accepted by [IJCV](https://link.springer.com/journal/11263). See the latest [Full paper](https://kkgithub.com/IceClear/StableSR/releases/download/UncompressedPDF/StableSR_IJCV_Uncompressed.pdf).
- **2024.02.29**: Support StableSR with [SD-Turbo](https://huggingface.co/stabilityai/sd-turbo). Thank [Andray](https://kkgithub.com/light-and-ray) for the finding!

  Now the [ComfyUI](https://kkgithub.com/gameltb/comfyui-stablesr) [![GitHub Stars](https://img.shields.io/github/stars/gameltb/comfyui-stablesr?style=social)](https://kkgithub.com/gameltb/comfyui-stablesr) of StableSR is also available. Thank [gameltb](https://kkgithub.com/gameltb) and [WSJUSA](https://kkgithub.com/WSJUSA) for the implementation!
...
- **2023.07.31**: Integrated to :rocket: [Replicate](https://replicate.com/explore). Try out online demo! [![Replicate](https://img.shields.io/badge/Demo-%F0%9F%9A%80%20Replicate-blue)](https://replicate.com/cjwbw/stablesr) Thank [Chenxi](https://kkgithub.com/chenxwh) for the implementation!
- **2023.07.16**: You may reproduce the LDM baseline used in our paper using [LDM-SRtuning](https://kkgithub.com/IceClear/LDM-SRtuning) [![GitHub Stars](https://img.shields.io/github/stars/IceClear/LDM-SRtuning?style=social)](https://kkgithub.com/IceClear/LDM-SRtuning).
...
- **2023.05.20**: :whale: The [**WebUI**](https://kkgithub.com/pkuliyi2015/sd-webui-stablesr) [![GitHub Stars](https://img.shields.io/github/stars/pkuliyi2015/sd-webui-stablesr?style=social)](https://kkgithub.com/pkuliyi2015/sd-webui-stablesr) of StableSR is available. Thank [Li Yi](https://kkgithub.com/pkuliyi2015) for the implementation!
...
- **More examples**.
  - [4K Demo1](https://imgsli.com/MTc4MDg3), which is a 4x SR on the image from [here](https://kkgithub.com/pkuliyi2015/multidiffusion-upscaler-for-automatic1111).
  - [4K Demo2](https://imgsli.com/MTc4NDk2), which is a 8x SR on the image from [here](https://kkgithub.com/Mikubill/sd-webui-controlnet/blob/main/tests/images/ski.jpg).
  - More comparisons can be found [here](https://kkgithub.com/IceClear/StableSR/issues/2) and [here](https://kkgithub.com/pkuliyi2015/sd-webui-stablesr).
...
git clone https://kkgithub.com/IceClear/StableSR.git
cd StableSR
...
# Install taming & clip
pip install -e git+https://kkgithub.com/CompVis/taming-transformers.git@master#egg=taming-transformers
pip install -e git+https://kkgithub.com/openai/CLIP.git@main#egg=clip
pip install -e .
```
...
- Train Time-aware encoder with SFT: set the ckpt_path in config files ([Line 22](https://kkgithub.com/IceClear/StableSR/blob/main/configs/stableSRNew/v2-finetune_text_T_512.yaml#L22) and [Line 55](https://kkgithub.com/IceClear/StableSR/blob/main/configs/stableSRNew/v2-finetune_text_T_512.yaml#L55))
```
python main.py --train --base configs/stableSRNew/v2-finetune_text_T_512.yaml --gpus GPU_ID, --name NAME --scale_lr False
```

- Train CFW: set the ckpt_path in config files ([Line 6](https://kkgithub.com/IceClear/StableSR/blob/main/configs/autoencoder/autoencoder_kl_64x64x4_resi.yaml#L6)).
...
- **DDIM is supported now. See [here](https://kkgithub.com/IceClear/StableSR/tree/main/scripts)**
...
#### Test FaceSR
You need to first generate reference images using [[CodeFormer](https://kkgithub.com/sczhou/CodeFormer)] or other blind face models.   
...
This project is licensed under <a rel="license" href="https://kkgithub.com/IceClear/StableSR/blob/main/LICENSE.txt">NTU S-Lab License 1.0</a>. Redistribution and use should follow this license.

### Acknowledgement

This project is based on [stablediffusion](https://kkgithub.com/Stability-AI/stablediffusion), [latent-diffusion](https://kkgithub.com/CompVis/latent-diffusion), [SPADE](https://kkgithub.com/NVlabs/SPADE), [mixture-of-diffusers](https://kkgithub.com/albarji/mixture-of-diffusers) and [BasicSR](https://kkgithub.com/XPixelGroup/BasicSR). Thanks for their awesome work.
