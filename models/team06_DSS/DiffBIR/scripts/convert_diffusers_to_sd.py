# https://kkgithub.com/huggingface/diffusers/blob/main/scripts/convert_diffusers_to_original_stable_diffusion.py
...
# Ordering is from https://kkgithub.com/pytorch/pytorch/blob/master/test/cpp/api/modules.cpp
