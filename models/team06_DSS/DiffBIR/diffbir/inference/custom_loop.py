...
class CustomInferenceLoop(InferenceLoop):
    ...
    def load_cldm(self) -> None:
        ...
        self.train_cfg.train.sd_path = os.path.join(self.args.model_dir, 'diffbir', 'v2-1_512-ema-pruned.ckpt')     ####################################
    ...
    def load_cleaner(self) -> None:
        ...
        self.train_cfg.train.swinir_path = os.path.join(self.args.model_dir, 'diffbir', '0150000.pt')       ####################################
