...
def parse_args() -> Namespace:
    ...
    parser.add_argument(
        "--ckpt",
        type=str,
        default="checkpoint_diffbir/v2.pth",
    ...
    parser.add_argument(
        "--output", type=str, required=False, default="result_diffbir", help="Path to save restored results."
    )
...
def main():
    ...
    set_seed(args.seed)
    args.ckpt = os.path.join(args.model_dir, 'diffbir', 'v2.pth')
