...
class MTCNN():
    ...
    def align(self, img):
        ...
        return boxes[0],facial5points,Image.fromarray(warped_face)
    ...
    def align_multi(self, img, limit=None):
        ...
        for landmark in landmarks:
            ...
            warped_face = warp_and_crop_face(np.array(img), facial5points, self.refrence, crop_size=self.crop_size)
            print(facial5points, boxes, img.size)
            import time
            time.sleep(100)
    ...
    def detect_faces(self, image, min_face_size, thresholds, nms_thresholds, factor):
        ...
        Returns:
            ...
            Upd: [n_boxes, 4] should be [n_boxes, 5], there are some editing in bounding_boxes[:, 4]
        """
